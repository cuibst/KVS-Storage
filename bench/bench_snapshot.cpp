...
DEFINE_uint32(snap_ratio, 1, "[0-100] the percentage of snapshot");
...
void explain()
{
    LOG(INFO) << "[explain] test_nr: " << FLAGS_test_nr
              ...
              << ", snapshot_ratio[0-100]: " << FLAGS_snap_ratio
...
void bench_kv(IEngine::Pointer engine)
{
    ...
    for (size_t i = 0; i < FLAGS_thread_nr; ++i)
    {
        ...
        double snap_ratio = 1.0 * FLAGS_snap_ratio / 100;
        double ins_ratio = (1 - read_ratio - snap_ratio) / 2;
